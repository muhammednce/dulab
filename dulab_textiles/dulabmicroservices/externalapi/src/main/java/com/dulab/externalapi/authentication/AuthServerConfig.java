...
import com.dulab.common.constants.NumericConstants;
...
public class AuthServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(final ClientDetailsServiceConfigurer clients) throws Exception {
        clients.inMemory()
                ...
                .scopes("user_info")
                .autoApprove(true)
                .redirectUris("http://localhost:3000", "https://www.getpostman.com/oauth2/callback");
    }
    ...
    public static String getMd5(final String input) {
        try {
            ...
            hashText.append(no.toString(NumericConstants.INT_16));

            while (hashText.length() < NumericConstants.INT_32) {
