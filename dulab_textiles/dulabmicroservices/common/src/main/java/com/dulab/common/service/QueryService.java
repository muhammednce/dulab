package com.dulab.common.service;


import com.dulab.common.dto.QueriesDTO;
import com.dulab.common.util.Function;
...
//    private String companyCode;
    ...
    public final void init() throws IOException {
        // load common queries
        var dashboardCommonQueries = new File(queryLocation + File.separator + "queries.xml");
        loadQueries(dashboardCommonQueries);
